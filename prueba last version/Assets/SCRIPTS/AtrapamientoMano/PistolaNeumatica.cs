...
public class PistolaNeumatica : MonoBehaviour
{
    public GameObject reactionBar;
    //public GameObject dado;
    public GameObject ObjRot;//dado
    public bool si_encendido;
    public bool si_agarrado;
    public bool si_posFinal;
    ...
    public void si_agarradoMano(bool si_)
    {
        si_agarrado = si_;
    }
}
