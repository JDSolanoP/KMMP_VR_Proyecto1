...
public class NewReturn_Pos0 : MonoBehaviour
{
    public Vector3 Pos0;
    ...
    public void SetPos0(Vector3 newPos0) => this.Pos0 = newPos0;
    public void SetRot0(Vector3 newRot0) => this.Rot0 = newRot0;
    public void SetAuxPos0(Vector3 newAuxPos0) => this.auxPos0 = newAuxPos0;
    public void SetAuxRot0(Vector3 newAuxRot0) => this.auxRot0 = newAuxRot0;
    public void SetTransform(Vector3 newPos0, Vector3 newRot0)
    {
        SetPos0(newPos0);
        SetRot0(newRot0);
    }
    public void SetAuxTransform(Vector3 newAuxPos0, Vector3 newAuxRot0)
    {
        SetAuxPos0(newAuxPos0);
        SetAuxRot0(newAuxRot0);
    }
}
